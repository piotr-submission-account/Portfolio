        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ClientCard
              ...
              isBlog={false}
              title="Preply"
              description="They believe learning with a great tutor is life changing. That's why they match online tutors from across the globe with learners, and empower them to create personalized live language classes with AI-powered tools and content. This is how they deliver progress, create engagement and keep their learners motivated."
              // ghLink="https://gitlab.com/sieminskipiotr3/airflow-astr-dbt-deployment"
              // demoLink="https://chatify-49.web.app/"
            />
          </Col>
